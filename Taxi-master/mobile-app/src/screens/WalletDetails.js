    ...
    return (
        <View style={styles.mainView}>
            <Header
                ...
                rightComponent={auth.info && auth.info.profile && auth.info.profile.usertype === 'driver' ?
                    <TouchableOpacity onPress={doWithdraw}><Text
                    ...
                    <View>
                        <View style={{flexDirection: 'row', justifyContent: "space-around", marginTop: 8}}>
                            <View style={{
                                ...
                                }}>{settings.symbol}{auth.info && auth.info.profile ? parseFloat(auth.info.profile.walletBalance).toFixed(2) : ''}</Text>
                            </View>
