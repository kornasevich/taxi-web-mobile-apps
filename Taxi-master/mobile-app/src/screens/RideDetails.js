            ...
            <ScrollView>
                ...
                <View style={styles.rideDesc}>
                    ...
                    <View style={styles.userDesc}>
                        ...
                        <View style={styles.userView}>
                            <Text
                                style={styles.textStyle}>{settings.symbol}{paramData && paramData.customer_paid ? parseFloat(paramData.customer_paid).toFixed(2) : paramData && paramData.estimate ? paramData.estimate : 0}</Text>
                        </View>
                    </View>
                </View>
                <View>
                    ...
                    <View style={styles.billView}>
                        ...
                        <View style={styles.billOptions}>
                            <View style={styles.billItem}>
                                ...
                                <Text
                                    style={styles.billAmount}>{settings.symbol} {paramData && paramData.trip_cost > 0 ? parseFloat(paramData.trip_cost).toFixed(2) : paramData && paramData.estimate ? parseFloat(paramData.estimate).toFixed(2) : 0}</Text>
                            </View>
                            <View style={styles.billItem}>
                                <View>
                                ...
                                <Text
                                    style={styles.discountAmount}> - {settings.symbol}{paramData && paramData.discount_amount ? parseFloat(paramData.discount_amount).toFixed(2) : 0}</Text>
                        ...
                        <View style={styles.paybleAmtView}>
                            ...
                            <Text
                                style={styles.billAmount2}>{settings.symbol}{paramData && paramData.customer_paid ? parseFloat(paramData.customer_paid).toFixed(2) : null}</Text>
                        </View>
                    </View>
                    : null}
                {paramData && ['PENDING', 'PAID', 'COMPLETE'].indexOf(paramData.status) !== -1 ?
