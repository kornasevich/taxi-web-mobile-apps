    ...
    return (
        <View style={styles.container}>
            ...
            {state.selectedProvider ?
                <PaymentWebView provider={state.selectedProvider} payData={state.payData} onSuccess={onSuccessHandler}
                                onCancel={onCanceledHandler}/> : null}
            {state.providers && state.selectedProvider == null ?
                <ScrollView>
                    {
                        state.providers.map((provider) => {
                            return (
                                <TouchableWithoutFeedback onPress={selectProvider.bind(this, provider)}
                                                          key={provider.name}>
